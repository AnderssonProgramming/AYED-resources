...
def main():
    print("**Inicio de la pila**")
    pila = Stack()
    print("Se agrega un libro: ")
    pila.push("Matematicas")
    print("=====")
    pila.printStack()
    print("=====")
    print("Se agrega otro libro a la pila: ")
    pila.push("Biblia")
    print("=====")
    pila.printStack()
    print("=====")
    print("Se agrega otro libro a la pila: ")
    pila.push("Recetas de cocina")
    print("=====")
    pila.printStack()
    print("=====")
    print("Se agrega otro libro a la pila: ")
    ...
    pila.printStack()
    print("=====")
    print("Se quitan dos libros: ")
    pila.pop()
    pila.pop()
    print("La pila final seria: ")
    print("=====")
    pila.printStack()
    print("=====")
